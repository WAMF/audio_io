...
class _GeminiLivePageState extends State<GeminiLivePage> {
  ...
  Future<void> _startAudio() async {
    ...
    _audioSubscription = AudioIo.instance.inputBytes.listen((pcmChunk) {
      ...
      // barge-in — audio_io provides no built-in echo cancellation on any
      // platform, so an always-open mic would feed model audio back into the
      // socket everywhere. See README "Limitations" for the full-duplex path.
