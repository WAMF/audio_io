...
// `example/ios` and `example/macos` RunnerTests. NOTE: this iOS RunnerTests
// target is not wired into example/ios/Runner.xcodeproj, so it does NOT run in
// CI — the macOS target (see .github/workflows/xctest.yml) is the load-bearing
// gate and covers this identical logic by construction.
